...
export class ForumoApiClient {
  ...
  readonly auth = {
    ...
    refresh: async (
      ...
      return this.requestJson<{ accessToken: string; refreshToken: string }>(
        "/auth/refresh",
        {
          method: "POST",
      ...
      const parsed = listingSearchParamsSchema.parse({
        ...
        minPriceCents:
          params.minPriceCents !== undefined
            ? Number(params.minPriceCents)
            : undefined,
        maxPriceCents:
          params.maxPriceCents !== undefined
            ? Number(params.maxPriceCents)
            : undefined,
        tags: params.tags,
        sort: params.sort,
  ...
  readonly orders = {
    ...
    listFiltered: async (params: {
      ...
      const response = await this.requestJson<SafeOrder[]>(
        `/orders?${qs.toString()}`,
    ...
    get: async (id: string): Promise<SafeOrder> => {
      const response = await this.requestJson<SafeOrder>(`/orders/${id}`, {
        method: "GET",
        auth: true,
      });
  ...
  readonly reviews = {
    ...
    rollup: async (sellerId: string): Promise<ReviewRollup> => {
      const result = await this.request<ReviewRollup>(
        `/reviews/seller/${sellerId}/rollup`,
        { method: "GET" },
      );
    ...
    vote: async (
      ...
      return this.requestJson<{ helpfulCount: number; userVoted: boolean }>(
  ...
  readonly messaging = {
    ...
    createThread: async (
      ...
      const result = await this.requestJson<SafeMessageThread>(
        "/messages/threads",
        {
          method: "POST",
          auth: true,
    ...
    markThreadRead: async (id: string): Promise<void> => {
      await this.patch<void>(`/messages/threads/${id}/read`, undefined, {
        auth: true,
      });
    },
    sendMessage: async (
  ...
  readonly notifications = {
    ...
    list: async (): Promise<SafeNotification[]> => {
      const result = await this.request<SafeNotification[]>("/notifications", {
        method: "GET",
        auth: true,
      });
    ...
    markAsRead: async (id: string): Promise<void> => {
      await this.requestJson<void>(`/notifications/${id}/read`, {
        method: "PATCH",
        auth: true,
      });
    },
    markAllAsRead: async (): Promise<void> => {
      await this.requestJson<void>("/notifications/mark-all-read", {
        method: "POST",
        auth: true,
      });
    },
  ...
  readonly admin = {
    listKycSubmissions: async (): Promise<AdminKycSubmission[]> => {
      const result = await this.request<AdminKycSubmission[]>(
    ...
    reviewKycSubmission: async (
      ...
      const result = await this.requestJson<AdminKycSubmission>(
    ...
    listListingsForReview: async (): Promise<AdminListingModeration[]> => {
      const result = await this.request<AdminListingModeration[]>(
        "/admin/moderations/listings",
        {
          method: "GET",
          auth: true,
        },
    ...
    reviewListing: async (
      ...
      const result = await this.requestJson<AdminListingModeration>(
        `/admin/moderations/listings/${id}`,
        {
          method: "PATCH",
          auth: true,
          body: payload,
    ...
    listDisputes: async (): Promise<AdminDisputeSummary[]> => {
      const result = await this.request<AdminDisputeSummary[]>(
        "/admin/disputes",
        { method: "GET", auth: true },
      );
    ...
    resolveDispute: async (
      ...
      const result = await this.requestJson<AdminDisputeSummary>(
        `/admin/disputes/${id}`,
        {
          method: "PATCH",
          auth: true,
    ...
    listUsers: async (
      ...
      const result = await this.request<AdminUserDetail[]>(
        `/admin/users${qs}`,
        { method: "GET", auth: true },
      );
  ...
  readonly auctions = {
    ...
    get: async (id: string): Promise<Auction> => {
      const result = await this.requestJson<Auction>(`/auctions/${id}`, {
        method: "GET",
      });
      return auctionSchema.parse(result);
    },
  ...
  readonly categories = {
    ...
    createCategory: async (payload: {
      ...
      return this.requestJson<ListingCategory>("/categories", {
        method: "POST",
        auth: true,
        body: payload,
      });
    ...
    updateCategory: async (
      ...
      return this.requestJson<ListingCategory>(`/categories/${id}`, {
        method: "PATCH",
        auth: true,
        body: payload,
      });
    ...
    createTag: async (payload: {
      ...
      return this.requestJson<ListingTag>("/categories/tags", {
        method: "POST",
        auth: true,
        body: payload,
      });
    ...
    updateTag: async (
      ...
      return this.requestJson<ListingTag>(`/categories/tags/${id}`, {
        method: "PATCH",
        auth: true,
        body: payload,
      });
    ...
    deleteTag: async (id: string): Promise<void> => {
      await this.request<void>(`/categories/tags/${id}`, {
        method: "DELETE",
        auth: true,
      });
    },
    assignCategories: async (
      ...
      await this.requestJson<void>(
        `/categories/listings/${listingId}/categories`,
        {
          method: "POST",
          auth: true,
  ...
  readonly wishlist = {
    list: async (): Promise<SavedListing[]> => {
      const result = await this.request<SavedListing[]>("/wishlist", {
        method: "GET",
        auth: true,
      });
    ...
    save: async (listingId: string): Promise<SavedListing> => {
      const result = await this.requestJson<SavedListing>(
        `/wishlist/${listingId}`,
        {
          method: "POST",
          auth: true,
    ...
    remove: async (listingId: string): Promise<void> => {
      await this.request<void>(`/wishlist/${listingId}`, {
        method: "DELETE",
        auth: true,
      });
    },
  ...
  readonly offers = {
    list: async (): Promise<SafeOffer[]> => {
      const result = await this.request<SafeOffer[]>("/offers", {
        method: "GET",
        auth: true,
      });
    ...
    decline: async (id: string): Promise<SafeOffer> => {
      const result = await this.requestJson<SafeOffer>(
        `/offers/${id}/decline`,
        {
          method: "POST",
          auth: true,
  ...
  readonly users = {
    getProfile: async (): Promise<UserProfileData> => {
      return this.request<UserProfileData>("/users/me/profile", {
        method: "GET",
        auth: true,
      });
    },
    ...
    deleteAvatar: async (): Promise<SafeUser> => {
      const result = await this.request<SafeUser>("/users/me/avatar", {
        method: "DELETE",
        auth: true,
      });
      return safeUserSchema.parse(result);
    ...
    createAddress: async (payload: any) => {
      return this.requestJson<any>("/users/me/addresses", {
        method: "POST",
        auth: true,
        body: payload,
      });
    ...
    updateAddress: async (id: string, payload: any) => {
      return this.requestJson<any>(`/users/me/addresses/${id}`, {
        method: "PATCH",
        auth: true,
        body: payload,
      });
    ...
    deleteAddress: async (id: string) => {
      await this.request<void>(`/users/me/addresses/${id}`, {
        method: "DELETE",
        auth: true,
      });
    },
    acceptTerms: async (): Promise<void> => {
      await this.request<void>("/users/me/accept-terms", {
        method: "POST",
        auth: true,
      });
    },
    ...
    becomeSeller: async (): Promise<SafeUser> => {
      const result = await this.requestJson<SafeUser>(
  ...
  readonly legal = {
    acceptTos: async (version: string): Promise<void> => {
      await this.requestJson<void>("/legal/accept-tos", {
        method: "POST",
        auth: true,
        body: { version },
      });
    ...
    deleteAccount: async (): Promise<{ scheduledAt: string }> => {
      return this.requestJson<{ scheduledAt: string }>(
        "/legal/delete-account",
        { method: "POST", auth: true },
      );
    },
    cancelDeletion: async (): Promise<void> => {
      await this.requestJson<void>("/legal/cancel-deletion", {
        method: "POST",
        auth: true,
      });
    },
    exportData: async (): Promise<Record<string, unknown>> => {
      return this.request<Record<string, unknown>>("/legal/data-export", {
        method: "GET",
        auth: true,
      });
    },
  ...
  readonly inventory = {
    getByVariant: async (
      ...
      return this.request(`/inventory/variant/${variantId}`, {
        method: "GET",
        auth: true,
      });
    },
    addStock: async (
      variantId: string,
      payload: { quantity: number; location?: string; metadata?: any },
    ) => {
      return this.requestJson(`/inventory/variant/${variantId}/add`, {
        method: "POST",
        auth: true,
        body: payload,
      });
    ...
    adjustStock: async (
      ...
      return this.requestJson(`/inventory/variant/${variantId}/adjust`, {
        method: "POST",
        auth: true,
        body: payload,
      });
    ...
    markDamaged: async (
      ...
      return this.requestJson(`/inventory/items/${itemId}/damage`, {
        method: "POST",
        auth: true,
        body: payload,
      });
  ...
  readonly payouts = {
    ...
    list: async (
      ...
      return this.request(`/payouts?page=${page}`, {
        method: "GET",
        auth: true,
      });
    },
    ...
    requestPayout: async (
      ...
      return this.requestJson("/payouts/request", {
        method: "POST",
        auth: true,
        body: { amountCents },
      });
  ...
  readonly fees = {
    preview: async (
      ...
      return this.request<FeePreview>(
        `/fees/preview?listingId=${encodeURIComponent(listingId)}&subtotalCents=${subtotalCents}`,
        {
          method: "GET",
          auth: true,
        },
  ...
  readonly adminFeeSchedules = {
    list: async (): Promise<FeeSchedule[]> => {
      return this.request<FeeSchedule[]>("/admin/fee-schedules", {
        method: "GET",
        auth: true,
      });
    },
    create: async (payload: CreateFeeScheduleDto): Promise<FeeSchedule> => {
      return this.requestJson<FeeSchedule>("/admin/fee-schedules", {
        method: "POST",
        auth: true,
        body: payload,
      });
    ...
    update: async (
      id: string,
      payload: UpdateFeeScheduleDto,
    ): Promise<FeeSchedule> => {
      return this.requestJson<FeeSchedule>(`/admin/fee-schedules/${id}`, {
        method: "PUT",
        auth: true,
        body: payload,
      });
    ...
    remove: async (id: string): Promise<void> => {
      await this.request<void>(`/admin/fee-schedules/${id}`, {
        method: "DELETE",
        auth: true,
      });
    },
  ...
  readonly storefronts = {
    ...
    get: async (slug: string): Promise<Storefront> => {
      const result = await this.requestJson<Storefront>(
        `/storefronts/${slug}`,
        { method: "GET" },
      );
      return storefrontSchema.parse(result);
    ...
    getMine: async (): Promise<Storefront | null> => {
      try {
        const result = await this.request<Storefront>("/storefronts/me", {
          method: "GET",
          auth: true,
        });
        return result ? storefrontSchema.parse(result) : null;
    ...
    remove: async (): Promise<void> => {
      await this.request<void>("/storefronts/me", {
        method: "DELETE",
        auth: true,
      });
    },
    ...
    > => {
      return this.request("/storefronts/me/collections", {
        method: "GET",
        auth: true,
      });
    },
    createCollection: async (payload: {
      ...
      return this.requestJson("/storefronts/me/collections", {
        method: "POST",
        auth: true,
        body: payload,
      });
    ...
    updateCollection: async (
      id: string,
      payload: { name?: string; description?: string; productIds?: string[] },
    ) => {
      return this.requestJson(`/storefronts/me/collections/${id}`, {
        method: "PATCH",
        auth: true,
        body: payload,
      });
    ...
    deleteCollection: async (id: string): Promise<void> => {
      await this.request<void>(`/storefronts/me/collections/${id}`, {
        method: "DELETE",
        auth: true,
      });
    },
  ...
  readonly returns = {
    initiate: async (
      orderId: string,
      payload: InitiateReturnDto,
    ): Promise<SafeReturn> => {
      const result = await this.requestJson<SafeReturn>(
    ...
    list: async (): Promise<SafeReturn[]> => {
      const result = await this.request<SafeReturn[]>("/returns", {
        method: "GET",
        auth: true,
      });
    ...
    get: async (id: string): Promise<SafeReturn> => {
      const result = await this.request<SafeReturn>(`/returns/${id}`, {
        method: "GET",
        auth: true,
      });
      return safeReturnSchema.parse(result);
  ...
  readonly cart = {
    ...
    addItem: (
      ...
      this.request<unknown>("/cart/items", {
        method: "POST",
        auth: true,
        body: JSON.stringify({ listingId, quantity, variantId, variantLabel }),
      }),
    ...
    merge: (
      ...
      this.request<unknown>("/cart/merge", {
        method: "POST",
        auth: true,
  ...
  readonly analytics = {
    getOverview: (period: "7d" | "30d" | "90d" = "30d") =>
      this.request<SellerAnalyticsOverview>(
        `/analytics/seller/overview?period=${period}`,
        { method: "GET", auth: true },
      ),
    ...
    getTopListings: (limit = 5) =>
      this.request<SellerTopListing[]>(
        `/analytics/seller/top-listings?limit=${limit}`,
        { method: "GET", auth: true },
      ),

    getReviewsSummary: () =>
      this.request<SellerReviewsSummary>("/analytics/seller/reviews-summary", {
        method: "GET",
        auth: true,
      }),
  };
