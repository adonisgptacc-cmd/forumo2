...
export const WithHeading: Story = {
  render: () => (
    <Card className="p-4">
      <h3 className="mb-1 text-base font-semibold text-gray-900">Order #1234</h3>
...
export const CustomPadding: Story = {
  render: () => (
    <Card className="p-8">
      <p className="text-sm text-gray-700">This card has extra padding applied via <code>className</code>.</p>
    </Card>
  ),
};
