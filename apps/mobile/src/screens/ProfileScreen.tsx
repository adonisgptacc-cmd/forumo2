    ...
    >
      ...
      <View style={styles.avatarSection}>
        ...
        <View style={styles.roleBadge}>
          <Text style={styles.roleBadgeText}>{displayUser?.role ?? 'BUYER'}</Text>
        </View>
      </View>
      ...
      {loading ? (
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            {!editing ? (
              <TouchableOpacity onPress={() => setEditing(true)} testID="edit-profile-btn">
...
const styles = StyleSheet.create({
  ...
  roleBadge: { backgroundColor: '#f3f4f6', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 3 },
  ...
  trustSub: { fontSize: 13, color: brandColors.muted, alignSelf: 'flex-end', paddingBottom: 4 },
  ...
  saveBtn: { backgroundColor: brandColors.primary, borderRadius: 10, paddingVertical: 13, alignItems: 'center' },
  btnDisabled: { opacity: 0.6 },
  saveBtnText: { color: '#fff', fontWeight: '700', fontSize: 15 },
  cancelBtn: { borderRadius: 10, paddingVertical: 12, alignItems: 'center', borderWidth: 1, borderColor: '#e5e7eb' },
