    ...
    <FlatList
      ...
      ListEmptyComponent={
        <View style={styles.centered}>
          ...
          <Text style={styles.emptySub}>Browse listings and tap ♡ to save items.</Text>
          <TouchableOpacity
      ...
      renderItem={({ item }) => {
        ...
        return (
          <TouchableOpacity
            style={styles.card}
            onPress={() => navigation.push('ListingDetail', { listingId: listing.id, listing })}
...
const styles = StyleSheet.create({
  ...
  emptySub: { fontSize: 14, color: brandColors.muted, textAlign: 'center', marginBottom: spacing.lg },
  browseBtn: {
