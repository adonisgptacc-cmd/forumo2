...
export const ListingDetailScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  const [listing, setListing] = useState<SafeListing | undefined>(
    initialListing,
  );
  ...
  const activePriceCents =
    selectedVariant?.priceCents ?? listing?.priceCents ?? 0;
    ...
    <>
      ...
      >
        ...
        <Text style={styles.price}>
          {formatCents(activePriceCents, currency)}
        </Text>
                ...
                >
                  ...
                  {v.priceCents !== listing.priceCents && (
                    <Text style={styles.variantPrice}>
                      {formatCents(v.priceCents, v.currency ?? currency)}
                    </Text>
                  )}
                </TouchableOpacity>
              ))}
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.push("Storefront", { sellerId: listing.sellerId })
          }
        >
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.modalSub}>
              Listed at {formatCents(listing.priceCents, listing.currency)}
            </Text>
            ...
            <View style={styles.modalActions}>
              <TouchableOpacity
                style={[
                  ...
                  submittingOffer && styles.btnDisabled,
                ]}
