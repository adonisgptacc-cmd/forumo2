        ...
        <div className="container">
          <div className="topbar-inner">
            ...
            >
              <Icon.search />
              <input
                placeholder="Search restored, vintage, hand-made…"
                value={q}
      ...
      <nav className="subnav">
        <div className="container">
          <div className="subnav-inner">
            <a
              className={`subnav-item ${currentScreen === "home" ? "active" : ""}`}
              onClick={() => go({ screen: "home" })}
            >
              Browse
            </a>
            <a
              className={`subnav-item ${currentScreen === "listings" ? "active" : ""}`}
            ...
            <a className="subnav-item sell" style={{ marginLeft: "auto" }}>
              + Sell on Forumo
            </a>
          </div>
        </div>
    ...
    >
      ...
      <div className="body">
        ...
        <div className="meta">
          ...
          {trust !== "subtle" && seller.verified && (
            <Icon.check
              style={{ width: 10, height: 10, color: "var(--escrow)" }}
            />
          )}
        </div>
...
function HomeScreen({ go, cardStyle, trust, onAddToCart }) {
  return (
    <main
      className="container"
      style={{ padding: "calc(40px * var(--sp)) calc(32px * var(--sp))" }}
    >
      {/* Hero */}
      <section
        style={{
      ...
      >
        <div className="stack" style={{ gap: 20 }}>
          ...
          >
            Vetted sellers across Lagos, Accra, Nairobi and Johannesburg. Funds
            sit in escrow until you confirm the package matches the listing —
            every order.
          </p>
          ...
          {trust !== "subtle" && (
            <div
              className="row home-trust-pillar"
              style={{
                gap: 24,
                marginTop: 8,
                color: "var(--ink-3)",
            ...
            >
              <span className="row" style={{ gap: 6 }}>
                ...
                2,431 orders protected this week
              </span>
              <span className="row" style={{ gap: 6 }}>
                <Icon.shield style={{ width: 14, height: 14 }} />
                98% of disputes resolved &lt; 48h
              </span>
            </div>
          )}
        </div>
        <div style={{ position: "relative" }}>
          <Placeholder
            label="hero — curated objects"
            style={{ aspectRatio: "5/4", borderRadius: "var(--r-xl)" }}
          />
          <div
            style={{
              position: "absolute",
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 13, fontWeight: 500 }}>
                Escrow released — Order ORD-92831
              </div>
              <div
                className="mono"
                style={{ fontSize: 11, color: "var(--ink-3)" }}
              >
                Paid · Shipped · Delivered · Released · 4h 22m
              </div>
            </div>
            <span className="pill pill-escrow">
      ...
      <section style={{ marginBottom: "calc(40px * var(--sp))" }}>
        <SectionHeading
          ...
          title="By category"
          action="See all"
          onAction={() => go({ screen: "listings" })}
        />
        <div className="row" style={{ gap: 8, flexWrap: "wrap" }}>
          {CATEGORIES.map((c, i) => (
            <button key={c} className={`chip ${i === 1 ? "active" : ""}`}>
              {c}
            </button>
          ))}
        </div>
      ...
      <section style={{ marginBottom: "calc(56px * var(--sp))" }}>
        <SectionHeading
          eyebrow="Just listed"
          title="New from verified sellers"
      ...
      >
        ...
        >
          <div>
            ...
            <h2 className="h1" style={{ marginBottom: 12 }}>
              Ile Atelier — handwoven textiles from Ibadan
            </h2>
            <p
              style={{
                color: "var(--ink-2)",
            ...
            >
              Sade Balogun has been listing on Forumo since 2024. Each aso-oke
              piece is woven on a pit loom and dyed with indigo from her
              cooperative — listed once, shipped within 48 hours.
            </p>
            <div className="row" style={{ gap: 14 }}>
              <Avatar name="Sade Balogun" size={40} />
              <div>
                <div style={{ fontWeight: 500 }}>
                  Sade Balogun · <VerifiedBadge />
                </div>
                <div style={{ fontSize: 12, color: "var(--ink-3)" }}>
                  5.0 · 78 reviews · Replies in ~2h
                </div>
              </div>
  ...
  return (
    ...
    >
      ...
      >
        <aside
          className="stack"
          style={{ gap: 24, position: "sticky", top: 90, alignSelf: "start" }}
        >
          <div>
          ...
          <div>
            ...
            <div className="stack" style={{ gap: 6 }}>
              {["New from maker", "Excellent", "Very good", "Good", "Fair"].map(
                (c) => (
                  <label
                    key={c}
                    className="row"
          ...
          <div>
            ...
            <div className="stack" style={{ gap: 6 }}>
              ...
              <label className="row" style={{ gap: 8, fontSize: 13 }}>
                <input type="checkbox" /> Replies &lt; 1h
              </label>
              <label className="row" style={{ gap: 8, fontSize: 13 }}>
                <input type="checkbox" /> 4.5+ rating
              </label>
            </div>
          </div>
        </aside>
...
function ListingDetailScreen({ id, go, onAddToCart, trust }) {
  ...
  return (
    <main
      className="container"
      style={{ padding: "calc(28px * var(--sp)) calc(32px * var(--sp))" }}
    >
      <div
        className="row"
        style={{
      ...
      >
        <a onClick={() => go({ screen: "home" })} style={{ cursor: "pointer" }}>
          Browse
        </a>
        <span>/</span>
        <a
      ...
      >
        ...
        <div className="stack" style={{ gap: 16 }}>
          ...
          <div className="row" style={{ gap: 10 }}>
            <Stars value={seller.rating} />
            <a style={{ fontSize: 13, color: "var(--ink-2)" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 13, color: "var(--ink-3)", marginTop: 6 }}>
              Your funds are held by Forumo until you confirm the item matches
              the listing.
          ...
          <div className="stack" style={{ gap: 8 }}>
            ...
            <div className="row" style={{ gap: 8 }}>
              ...
              <Btn
                variant="ghost"
                size="sm"
                icon={<Icon.scale style={{ width: 14, height: 14 }} />}
              >
                Make offer
              </Btn>
              <Btn
                variant="ghost"
                size="sm"
                icon={<Icon.heart style={{ width: 14, height: 14 }} />}
              >
                Save
              </Btn>
            </div>
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 12, color: "var(--ink-3)" }}>
                Standard 3-5 days · Insured · Free returns within 7 days
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row" style={{ gap: 16 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 13, color: "var(--ink-3)" }}>
              {seller.name} · {seller.location} · Joined {seller.joined}
            </div>
            <div
              className="row"
              style={{ gap: 16, marginTop: 8, fontSize: 13 }}
            >
              <span>
                <strong>{seller.rating}</strong> rating
              </span>
              <span>
                <strong>{seller.reviews}</strong> reviews
              </span>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        {tab === "description" && (
          ...
          >
            <p>
              Acquired from an estate in Surulere and fully restored over six
              weeks: lacquer stripped, splits filled, brass pulls polished,
              interior re-lined with bespoke cotton.
            </p>
            <p>
              Dimensions: 180 × 76 × 45 cm. Solid walnut with sliding doors.
              Sits flat on level floors. Interior has three cedar-lined shelves
              on the right.
            </p>
            <p>
              Pickup welcome in Lagos. White-glove crating available for
              shipping anywhere in Nigeria — quoted on request.
            </p>
          </div>
        )}
        {tab === "condition" && (
          <div className="card card-pad" style={{ maxWidth: 720 }}>
            <div className="row-between">
              <span>Frame</span>
              <Pill tone="escrow">Excellent</Pill>
            </div>
            <hr className="divider" style={{ margin: "14px 0" }} />
            <div className="row-between">
              <span>Finish</span>
              <Pill tone="escrow">Refinished</Pill>
            </div>
            <hr className="divider" style={{ margin: "14px 0" }} />
            <div className="row-between">
              <span>Hardware</span>
        ...
        {tab === "shipping" && (
          <div className="stack" style={{ maxWidth: 720, gap: 16 }}>
            <div className="row" style={{ gap: 12 }}>
              ...
              <div>
                <div style={{ fontWeight: 500 }}>
                  Standard delivery — NGN 12,500
                </div>
                <div style={{ fontSize: 13, color: "var(--ink-3)" }}>
                  3–5 business days · Insured · Tracked
                </div>
              </div>
            </div>
            <div className="row" style={{ gap: 12 }}>
              ...
              <div>
                <div style={{ fontWeight: 500 }}>
                  White-glove crating — quoted on request
                </div>
                <div style={{ fontSize: 13, color: "var(--ink-3)" }}>
                  For large or fragile items · Message seller for pricing
                </div>
              </div>
            </div>
          </div>
