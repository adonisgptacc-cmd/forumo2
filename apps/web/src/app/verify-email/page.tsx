  ...
  return (
    <main className="mx-auto max-w-md space-y-8">
      <div className="space-y-2 text-center">
        <p className="text-xs uppercase tracking-[0.3em] text-[color:var(--ink-3)]">Email verification</p>
          ...
          <div className="space-y-4">
            <div className="flex flex-col items-center gap-3 py-2">
              <div className="flex h-12 w-12 items-center justify-center rounded-full border border-amber-200 bg-amber-50">
                <svg className="h-6 w-6 text-[color:var(--accent)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                </svg>
              </div>
              <div className="text-center">
                <p className="font-medium text-[color:var(--ink)]">Check your inbox</p>
                <p className="mt-1 text-sm muted">
                  We sent a verification link to{' '}
                  {resendEmail ? <span className="font-medium text-[color:var(--ink-2)]">{resendEmail}</span> : 'your email address'}.
                  Click the link to activate your account.
                </p>
              </div>
            </div>
            <div className="border-t border-[color:var(--line)] pt-4 space-y-3">
              <p className="text-xs muted text-center">Didn&apos;t receive it?</p>
              <form
                onSubmit={async (e) => {
                  e.preventDefault();
                  setResendError(null);
