  ...
  return (
    <div className="card-forumo">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link
          href="/listings"
          className="text-forumo-link text-sm hover:text-forumo-orange"
        >
          View all listings
        </Link>
      </div>
      <div className="stagger grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        {data.data.slice(0, 12).map((listing) => (
          ...
          >
            ...
            <p className="text-sm font-medium truncate group-hover:text-forumo-link">
              {listing.title}
            </p>
            {listing.location && (
      ...
      {data.total > 12 && (
        <div className="mt-4 text-center">
          <Link
            href="/listings"
            className="text-forumo-link hover:text-forumo-orange text-sm font-medium"
          >
