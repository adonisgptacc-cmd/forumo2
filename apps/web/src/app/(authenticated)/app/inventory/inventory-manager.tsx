          ...
          {mode === 'add' && (
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="w-36 rounded-lg border border-[color:var(--line-2)] bg-[color:var(--surface)] px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)]"
          ...
          {mode === 'adjust' && (
            <div className="flex flex-col gap-1 flex-1 min-w-40">
              ...
              <input
                ...
                className="rounded-lg border border-[color:var(--line-2)] bg-[color:var(--surface)] px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)]"
...
function ListingInventoryCard({ listing }: { listing: SafeListing }) {
  ...
  return (
    <div className="rounded-2xl border border-[color:var(--line)] bg-[color:var(--surface)] overflow-hidden">
      <button
        className="w-full flex items-center gap-4 p-4 hover:bg-[color:var(--surface)]/40 transition-colors text-left"
      ...
      >
        {listing.images?.[0]?.url ? (
          ...
          <div className="h-12 w-12 rounded-lg bg-[color:var(--surface-2)] flex items-center justify-center flex-shrink-0">
            <span className="text-[color:var(--ink-3)] text-xs">No img</span>
          </div>
        )}
