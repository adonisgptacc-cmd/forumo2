...
export default function MessagesError({
  ...
  return (
    <div className="flex min-h-[50vh] flex-col items-center justify-center text-center space-y-4 px-4">
      ...
      <h1 className="text-xl font-semibold text-slate-800">Messages couldn&apos;t load</h1>
      <p className="text-sm text-slate-500 max-w-sm">
        There was a problem loading your conversations. Your messages are safe — try again in a moment.
      </p>
      {error.digest && (
