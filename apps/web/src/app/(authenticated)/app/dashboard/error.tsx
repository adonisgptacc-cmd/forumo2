...
export default function DashboardError({
  ...
  return (
    <div className="flex min-h-[50vh] flex-col items-center justify-center text-center space-y-4 px-4">
      ...
      <h1 className="text-xl font-semibold text-slate-800">Dashboard is temporarily unavailable</h1>
      <p className="text-sm text-slate-500 max-w-sm">
        We couldn&apos;t load your seller dashboard. Your data is safe — please try again.
      </p>
      {error.digest && (
