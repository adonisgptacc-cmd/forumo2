  ...
  return (
    <div className="min-h-screen bg-[color:var(--bg)] flex items-center justify-center px-4">
      <div className="text-center space-y-4 max-w-md">
        ...
        <h1 className="text-2xl font-semibold text-[color:var(--ink)]">Something went wrong</h1>
        <p className="text-sm text-[color:var(--ink-3)]">
          An unexpected error occurred. Please try again or contact support if the problem persists.
        </p>
        {error.digest && (
          <p className="text-xs text-[color:var(--ink-3)] font-mono">Error ID: {error.digest}</p>
        )}
