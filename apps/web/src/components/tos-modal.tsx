...
function useTosStatus(accessToken?: string | null) {
  const [status, setStatus] = useState<"loading" | "required" | "ok">(
    "loading",
  );
  ...
  useEffect(() => {
    ...
    api.auth
      ...
      .then((auth) => {
        ...
        const needsTos =
          !user.termsAcceptedAt || user.tosVersion !== TOS_VERSION;
      ...
      <div className="relative mx-4 flex max-h-[90vh] w-full max-w-2xl flex-col rounded-2xl border border-[color:var(--line)] bg-[color:var(--surface)] shadow-2xl">
        ...
        <div className="shrink-0 border-b border-[color:var(--line)] px-6 py-5">
          ...
          <p className="mt-1 text-sm muted">
            Please read and accept our Terms of Service to continue using
            Forumo.
          </p>
        </div>
        ...
        >
          ...
          <p>
            By accessing or using Forumo (&quot;the Platform&quot;), you agree
          ...
          <p>
            You must be at least 18 years old to use Forumo. By using the
            Platform, you represent that you meet this age requirement and have
          ...
          <p>
            ...
            of your account. Forumo reserves the right to suspend or terminate
          ...
          <p>
            You agree not to list prohibited items, engage in fraudulent
            transactions, circumvent the escrow system, or otherwise act in bad
            faith. Forumo uses escrow to protect buyers and sellers; funds are
          ...
          <p>
            Forumo charges a platform fee on completed transactions. Fee
            schedules are published on the Platform and may change with 30
            days&apos; notice. You are responsible for any applicable taxes.
          </p>
          ...
          <p>
            ...
            Privacy Policy. You have the right to access, correct, and delete
            your personal data at any time from your account settings. We retain
            anonymised financial records for 7 years as required by law.
          </p>
          ...
          <p>
            All content you upload to Forumo remains yours. By uploading, you
            grant Forumo a non-exclusive licence to display and process that
          ...
          <p>
            To the maximum extent permitted by law, Forumo shall not be liable
            for indirect, incidental, or consequential damages arising from your
            use of the Platform. Our aggregate liability shall not exceed the
            fees you paid to Forumo in the preceding 12 months.
          </p>
          ...
          <p>
            Disputes between buyers and sellers are handled through
            Forumo&apos;s dispute resolution process. Either party may escalate
            to Forumo support. Forumo&apos;s decision is final for
          ...
          <p>
            Forumo may update these Terms. We will notify you by email and
            require re-acceptance when material changes are made. Continued use
            after acceptance constitutes agreement to the updated Terms.
          </p>
        ...
        <div className="shrink-0 border-t border-[color:var(--line)] px-6 py-4">
          ...
          {acceptTos.isError && (
            <p className="mt-2 text-center text-xs text-red-600">
              {(acceptTos.error as Error)?.message ??
