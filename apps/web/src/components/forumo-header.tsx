...
export function ForumoHeader() {
  ...
  function handleSearch(event: React.FormEvent) {
    ...
    router.push(
      `/listings${params.toString() ? `?${params.toString()}` : ""}` as any,
    );
  }
  ...
  return (
    <header>
      ...
      {/* Sub-nav */}
      <div
        className="forumo-sub-header scrollbar-none"
        style={{
          display: "flex",
          alignItems: "center",
          gap: 2,
