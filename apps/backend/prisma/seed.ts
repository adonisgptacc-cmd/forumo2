...
async function main() {
  ...
  const adminPassword = await bcrypt.hash(
    process.env.ADMIN_PASSWORD ?? "Admin@forumo2026!",
    10,
  );
  ...
  const sampleListings = [
    ...
    },
    {
      ...
      description:
        "Apple iPhone 14 Pro Max, 256GB, Space Black. Like new condition.",
      priceCents: 120000,
    },
    {
    ...
    },
    {
      ...
      description:
        "Trek mountain bike, 2022 model, 21-speed, great for trails.",
      priceCents: 50000,
    },
    {
      title: "Vintage Analog Camera",
      description:
        "Canon AE-1 35mm camera with original lens, fully functional.",
      priceCents: 25000,
    },
    {
      title: "Yoga Mat & Equipment Set",
      description:
        "Complete yoga set with mat, blocks, straps, and carrying bag.",
      priceCents: 8000,
    },
  ];
