...
- **Note**: One failing test in `src/types.test.ts` — password validation edge case. Non-blocking for MVP.
...
| 4 | **@forumo/shared has 1 failing test** | Low | Password validation edge case; does not affect runtime behavior. Tracked in `#142`. |
